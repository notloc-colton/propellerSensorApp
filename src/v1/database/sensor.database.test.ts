...
describe('SensorDatabase', () => {
  ...
  it('should get air quality data by sensorId correctly', () => {
    ...
    const retrievedData = SensorDatabase.getAirQualityDataBySensorId(mockData.sensorId);
  ...
  it('should return empty array for nonexistent sensorId', () => {
    const retrievedData = SensorDatabase.getAirQualityDataBySensorId('imNotReal');
