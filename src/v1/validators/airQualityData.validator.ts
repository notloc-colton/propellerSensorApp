...
export async function validateAirQualityData(
  req: Request,
  res: Response,
  ...
  let errors: string[] = [];
  const carbonMonoxideError = validateDataPoint(
    "carbonMonoxide",
    body.carbonMonoxide,
    50.4,
    0,
  ...
  const groundLevelOzoneError = validateDataPoint(
    "groundLevelOzone",
    body.groundLevelOzone,
    0.604,
    0,
  );
  ...
  const nitrogenDioxideError = validateDataPoint(
    "nitrogenDioxide",
    body.nitrogenDioxide,
    2049,
    0,
  );
  ...
  const sulfurDioxideeError = validateDataPoint(
    "sulfurDioxide",
    body.sulfurDioxide,
    1004,
    0,
